...
=========================================================================
  ...
  This is an example progam that may be useful for reference :
   ...
   Uses the SpoutDX support class library and dll (x64).
   SpoutDX.lib and SpoutDX.dll can be found in the SpoutDX\libs folder.
   Build Visual Studio 2022 x64 /MD.

   SpoutDX.dll must be copied to the executable folder.
   ...
   Compare with the SDK SpoutDX example Windows sender.
